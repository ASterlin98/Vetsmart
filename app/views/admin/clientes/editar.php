...
<form method="POST" action="/vetsmart/admin/clientes/<?php echo $cliente['id']; ?>/actualizar">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="docusu" class="form-control" value="<?php echo htmlspecialchars($cliente['docusu']); ?>" required>
    </div>
    <div class="mb-3">
        <label>Email</label>
    ...
    <div class="mb-3">
        <label>Ciudad</label>
        <input type="text" name="ciudad" class="form-control" value="<?php echo htmlspecialchars($cliente['ciudad']); ?>" required>
    </div>
