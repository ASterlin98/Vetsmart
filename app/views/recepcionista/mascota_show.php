<div class="container py-3">
  <div class="card perfil-card shadow mx-auto" style="max-width:420px;">
    <div class="card-body text-center">
      ...
      ?>
      <img src="<?= BASE ?>/<?= htmlspecialchars($rutaFoto) ?>" class="rounded-circle mb-3 perfil-foto img-fluid" alt="Foto de <?= htmlspecialchars($mascota['nombre']) ?>">
  ...
  <div class="text-center mt-3">
    <a href="<?= BASE ?>/recepcionista/mascotas" class="btn btn-outline-secondary btn-sm"><i class="fas fa-arrow-left me-1"></i>Volver</a>
    <a href="<?= BASE ?>/recepcionista/mascotas/edit/<?= (int)($mascota['id'] ?? 0) ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit me-1"></i>Editar</a>
  </div>
</div>
