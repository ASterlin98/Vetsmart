<div class="container py-3">
  ...
  <div class="text-center mt-3">
    <a href="<?= BASE ?>/recepcionista/clientes" class="btn btn-outline-secondary btn-sm"><i class="fas fa-arrow-left me-1"></i>Volver</a>
    <a href="<?= BASE ?>/recepcionista/clientes/edit/<?= (int)($cliente['id'] ?? 0) ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit me-1"></i>Editar</a>
  </div>
</div>
